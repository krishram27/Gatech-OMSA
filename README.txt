...
Use the following steps to launch our dashboard:
    ...
    2. Run bay_area_housing_prediction.py to generate our GeoJSON file
        e.g. python bay_area_housing_prediction.py

    3. Copy and paste the output of the python file into your terminal. It should look something like this:
            cd "/Users/divya/Documents/GitHub/Gatech-OMSA/project_code"
            python3 -m http.server 8080
            Open: http://localhost:8080/housing_dashboard_final.html

    4. Open http://localhost:8080/bay_area_housing_dashboard.html and you're good to go!
